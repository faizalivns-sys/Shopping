// Sample home & kitchen product data
...
// DOM Elements
const homeKitchenProductsGrid = document.getElementById('home-kitchen-products-grid');
...
// Load home & kitchen products
function loadHomeKitchenProducts() {
    // Update product count
    productCount.textContent = `Showing ${homeKitchenProducts.length} products`;
    
    // Render products
    renderHomeKitchenProducts(homeKitchenProducts);
}

// Render home & kitchen products to the page
function renderHomeKitchenProducts(products) {
    homeKitchenProductsGrid.innerHTML = '';
    
    if (products.length === 0) {
        homeKitchenProductsGrid.innerHTML = '<p>No products found in this category.</p>';
        return;
    }
    ...
    products.forEach(product => {
        ...
        `;
        homeKitchenProductsGrid.appendChild(productCard);
    });
}
...
function addToCart(productId) {
    const product = homeKitchenProducts.find(p => p.id === productId);
