...
// DOM Elements
const booksProductsGrid = document.getElementById('books-products-grid');
...
// Load books products
function loadBooksProducts() {
    // Update product count
    productCount.textContent = `Showing ${booksProducts.length} products`;
    
    // Render products
    renderBooksProducts(booksProducts);
}

// Render books products to the page
function renderBooksProducts(products) {
    booksProductsGrid.innerHTML = '';
    
    if (products.length === 0) {
        booksProductsGrid.innerHTML = '<p>No products found in this category.</p>';
        return;
    }
    ...
    products.forEach(product => {
        ...
        `;
        booksProductsGrid.appendChild(productCard);
    });
}
